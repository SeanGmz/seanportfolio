...
const Info = () => {
  ...
  const Socials = ({ iconStyles }: { iconStyles: string }) => {
    return (
      <div className="flex flex-row xl:flex-col justify-center xl:justify-start items-center mb-10 xl:mb-0 ">
  ...
  return (
    <div className="border-solid border-2 xl:px-32 border-white-600 flex flex-col xl:flex-row items-center justify-between xl:pt-52 xl:pb-24">
      <div className="text-center xl:text-left pt-10 pb-5 xl:py-0">
        <h1 className="text-3xl mb-4 xl:text-6xl md:text-4xl sm:text-3xl font-bold">
        ...
        <button
          type="button"
          className="mt-5 mx-auto xl:mx-0 xl:mt-5 flex flex-row items-center text-accent  hover:text-background hover:bg-accent hover:border-accent border-accent border-[2px] rounded-full px-8 py-3 transition-all ease-in duration-150"
        >
          <span className="m-0 mr-2 font-semibold">DOWNLOAD CV</span>
