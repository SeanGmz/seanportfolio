...
const Info = () => {
  ...
  return (
    <div className="border-solid border-2 xl:px-32 border-white-600 flex flex-col xl:flex-row items-center justify-between xl:pt-40 xl:pb-24">
      <div className="text-center xl:text-left pt-10 pb-5 xl:py-0 order-2 xl:order-none">
      ...
      <div className="w-0 xl:w-2/5"> </div>
      ...
      <div className="order-3 xl:order-none">
        ...
        <div className="mx-auto order-1 xl:order-none mt-20 mb-2 xl:my-0">
          <ProfilePic />
        </div>
    </div>
  );
